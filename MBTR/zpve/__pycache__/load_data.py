...
def calmbtr(z,pos):
    ...
    mol_mbtr1 = mbtr1.create(mol)
    mol_mbtr2 = mbtr2.create(mol)
    mol_mbtr3 = mbtr3.create(mol)
    #print(mol_mbtr1.shape,mol_mbtr2.shape,mol_mbtr3.shape)
    mol_mbtr =np.concatenate((mol_mbtr1, mol_mbtr2, mol_mbtr3), axis=0)
    #mol_mbtr =np.concatenate((mol_mbtr1, mol_mbtr2),axis=0)
...
class ImproveQM9(QM9):
    ...
    def process(self):
        ...
        for i, mol in enumerate(tqdm(suppl)):
            ...
            #posc = pos - pos*z.mean()
            descrip = calmbtr(z,pos)
            descrip = torch.tensor(descrip, dtype=torch.float32)
            descrip = descrip.unsqueeze(0)
            #print(descrip.shape)
